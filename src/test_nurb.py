...
curve1 = crv.ArcCurve.from_radius_center_angle(
    radius=0.5, center=RIGHT * 0.5, angle_start=-PI / 2, angle_end=0
)
curve2 = crv.ArcCurve.from_2_point_center(
    p0=RIGHT, p1=RIGHT * 2 + DOWN, center=RIGHT + DOWN
)
